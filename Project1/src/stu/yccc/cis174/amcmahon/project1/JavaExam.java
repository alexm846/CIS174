...
public class JavaExam {
	...
	public void processFile(String questionFile, List<Question> questionList) {
	...
	public void processAnswerFile(String answerFile, List<Answer> answerList) {
	...
	public void run(String questionFile, String answerFile, String outFile) {
		...
		processFile(questionFile, questionList);
		processAnswerFile(answerFile, answerList);
		beginExam(questionList, answerList);
